...
let ClinicController = class ClinicController {
    async create({ currentUser: user }, _a) {
        var { name, startTime, endTime } = _a, rest = __rest(_a, ["name", "startTime", "endTime"]);
        ...
        clinic = await new Clinic().setACL(acl).save(Object.assign(Object.assign({}, rest), { name, startTime: new Date(startTime), endTime: new Date(endTime), creator: user }), { user });
    ...
    async edit({ currentUser: user }, id, _a) {
        ...
        await clinic.save(Object.assign(Object.assign({}, rest), { startTime: new Date(startTime), endTime: new Date(endTime) }), { user });
